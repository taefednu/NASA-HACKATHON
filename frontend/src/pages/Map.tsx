      ...
      <main className="pt-24 pb-12">
        <div className="container mx-auto px-4">
          <div className="mb-8 animate-fade-in">
            <h1 className="text-4xl font-bold mb-2">Интерактивная Карта Погоды</h1>
            <p className="text-muted-foreground">
              Исследуйте вероятности погоды в различных локациях
            </p>
          </div>
            ...
            <Card className="lg:col-span-1 p-6 h-fit shadow-card animate-slide-up">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="wind">Скорость Ветра</Label>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox id="comfort" />
                  <Label htmlFor="comfort">Индекс Комфорта</Label>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">День 195 (14 июля)</p>
              </div>
            ...
            <div className="lg:col-span-3 animate-slide-up">
                ...
                <div className="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-lg h-[600px] flex items-center justify-center border-2 border-dashed border-border">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground max-w-md">
                      Здесь будет визуализация тепловой карты, показывающая распределение вероятности погоды.
                      Нажмите на любую локацию, чтобы увидеть подробную статистику.
                    </p>
                  </div>
                </div>
              </Card>
              ...
              <div className="mt-6 grid md:grid-cols-3 gap-4">
                <Card className="p-4 shadow-card">
                  <h4 className="font-semibold mb-2">Выбранная Локация</h4>
                  <p className="text-2xl font-bold text-primary">Нью-Йорк, США</p>
                  <p className="text-sm text-muted-foreground">40.7128°N, 74.0060°W</p>
                </Card>
                <Card className="p-4 shadow-card">
                  <h4 className="font-semibold mb-2">Средняя Вероятность</h4>
                  <p className="text-2xl font-bold text-accent">45%</p>
                  <p className="text-sm text-muted-foreground">Экстремальные погодные условия</p>
                </Card>
                <Card className="p-4 shadow-card">
                  <h4 className="font-semibold mb-2">Точки Данных</h4>
                  <p className="text-2xl font-bold text-secondary">3,650</p>
                  <p className="text-sm text-muted-foreground">10-летние исторические записи</p>
                </Card>
              </div>
            </div>
          </div>
